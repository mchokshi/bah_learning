...
################################################################################
@dp.table(
    name="sdp_1_bronze.customers_bronze_raw_demo6_py",
...
################################################################################
@dp.table(
    name="sdp_1_bronze.customers_bronze_clean_demo6_py",
    comment="Raw data from customers CDC feed",
    table_properties={
        "quality": "bronze",
    }
...
def customers_bronze_clean_demo6():
    return (
        dp
        .read_stream("sdp_1_bronze.customers_bronze_raw_demo6_py")
        .select(
            "*",
...
dp.create_streaming_table(
    name = "sdp_2_silver.scd_type_1_customers_silver_demo6_py",
    comment = 'SCD Type 2 Historical Customer Data')


dp.create_auto_cdc_flow(
    target = "sdp_2_silver.scd_type_1_customers_silver_demo6_py",
    source = "sdp_1_bronze.customers_bronze_clean_demo6_py",
    keys = ["customer_id"],
