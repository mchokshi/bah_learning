...
@dp.table(name = "sdp_1_bronze.status_bronze_demo6_py",
...
@dp.table(name = "sdp_2_silver.status_silver_demo6_py",
...
def status_silver_demo6():
    return (
        dp.read_stream("sdp_1_bronze.status_bronze_demo6_py")
           .select(
                "order_id",
                "order_status",
...
@dp.materialized_view(
    name = "sdp_3_gold.full_order_info_gold_demo6_py",
...
def full_order_info_gold_demo6():
    return (
        dp
        .read("sdp_2_silver.status_silver_demo6_py").alias("status")
        .join(dp.read("sdp_2_silver.orders_silver_demo6_py").alias("orders"), on = "order_id", how = "inner")
        .select(
            "orders.order_id",
...
## CANCELLED ORDERS
@dp.materialized_view(
    name="sdp_3_gold.cancelled_orders_gold_demo6_py",
...
def cancelled_orders_gold_demo6():
    full_orders = dp.read("sdp_3_gold.full_order_info_gold_demo6_py")
    return (
        full_orders
...
## DELIVERED ORDERS
@dp.materialized_view(
    name="sdp_3_gold.delivered_orders_gold_demo6_py",
