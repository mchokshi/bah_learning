...
------------------------------------------------------------------------------------------------------------
CREATE OR REFRESH STREAMING TABLE sdp_1_bronze.customers_bronze_raw_demo6
...
---------------------------------------------------------------------------------------
CREATE STREAMING TABLE sdp_1_bronze.customers_bronze_clean_demo6
  (
...
FROM STREAM sdp_1_bronze.customers_bronze_raw_demo6;
...
CREATE OR REFRESH STREAMING TABLE sdp_2_silver.scd_type_1_customers_silver_demo6
  COMMENT 'SCD Type 1 Historical Customer Data';

-- Perform SCD TYPE 1
CREATE FLOW scd_type_1_flow AS 
AUTO CDC INTO sdp_2_silver.scd_type_1_customers_silver_demo6  -- Target table to update with SCD Type 1 (or 2)
FROM STREAM sdp_1_bronze.customers_bronze_clean_demo6  -- Source records to determine updates, deletes and inserts
