...
--------------------------------------------------------
-- Code below creates the bronze table **status_bronze_demo5** incrementally ingesting JSON files
...
--------------------------------------------------------
CREATE OR REFRESH STREAMING TABLE sdp_1_bronze.status_bronze_demo5
...
-- for the silver streaming table **status_silver_demo5**.
...
--------------------------------------------------------
CREATE OR REFRESH STREAMING TABLE sdp_2_silver.status_silver_demo5
(
...
FROM STREAM sdp_1_bronze.status_bronze_demo5;
...
--------------------------------------------------------
CREATE OR REFRESH MATERIALIZED VIEW sdp_3_gold.full_order_info_gold_demo5
...
FROM sdp_2_silver.status_silver_demo5 status
INNER JOIN sdp_2_silver.orders_silver_demo5 orders
...
-- CANCELLED ORDERS MV
CREATE OR REFRESH MATERIALIZED VIEW sdp_3_gold.cancelled_orders_gold_demo5
...
FROM sdp_3_gold.full_order_info_gold_demo5
WHERE order_status = 'canceled';

-- DELIVERED ORDERS MV
CREATE OR REFRESH MATERIALIZED VIEW sdp_3_gold.delivered_orders_gold_demo5
