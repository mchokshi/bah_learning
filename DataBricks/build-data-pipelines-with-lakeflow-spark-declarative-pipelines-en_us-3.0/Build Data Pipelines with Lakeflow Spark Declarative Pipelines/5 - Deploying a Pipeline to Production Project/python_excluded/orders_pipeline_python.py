...
@dp.table(name = "sdp_1_bronze.orders_bronze_demo5_py",
...
@dp.table(name = "sdp_2_silver.orders_silver_demo5_py",
...
def orders_silver_demo5():
    return (
        dp.read_stream("sdp_1_bronze.orders_bronze_demo5_py")
            .select(
                "order_id",
...
@dp.materialized_view(name = "sdp_3_gold.gold_orders_by_date_demo5_py",
...
def gold_orders_by_date_demo5():
    return (
        dp.read("sdp_2_silver.orders_silver_demo5_py")
