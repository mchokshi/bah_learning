...
SELECT *
FROM text.`/Volumes/dbacademy/ops/labuser15662059_1782220991@vocareum_com/csv_demo_files/lab_malformed_data.csv`;
...
SELECT * 
FROM read_files(
  '/Volumes/dbacademy/ops/labuser15662059_1782220991@vocareum_com/csv_demo_files/lab_malformed_data.csv',
  format => 'csv'
)
LIMIT 10;
...
COPY INTO 05_lab_bronze
  FROM '/Volumes/dbacademy/ops/labuser15662059_1782220991@vocareum_com/csv_demo_files/lab_malformed_data.csv'
  FILEFORMAT = csv
